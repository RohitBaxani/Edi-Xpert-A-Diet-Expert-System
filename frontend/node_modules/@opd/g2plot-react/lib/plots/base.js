...
function (_React$Component) {
  ...
  function BaseChart() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getConfig", function (props) {
      return (0, _omit.default)(props, ['style', 'className', 'chart', 'onMount']);
    });
  ...
  _createClass(BaseChart, [{
    ...
    value: function componentDidMount() {
      ...
      this.config = (0, _cloneDeep.default)(restConfig);
    ...
    value: function componentDidUpdate() {
      ...
      var isConfigChanged = !(0, _isEqual.default)(this.config, restConfig);
