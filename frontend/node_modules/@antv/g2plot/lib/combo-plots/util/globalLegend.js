...
function createLegend(items, width, height, canvas, position) {
    ...
    var legend = new dependents_1.Legend.Category(legendCfg);
    ...
    if (positions[0] === 'left') {
        paddingBbox = new bbox_1.default(legend.get('x') + innerPadding[3], legend.get('y'), bbox.width, bbox.height);
    }
    else if (positions[0] === 'right') {
        paddingBbox = new bbox_1.default(legend.get('x') - innerPadding[1], legend.get('y'), bbox.width, bbox.height);
    }
    else if (positions[0] === 'top') {
        paddingBbox = new bbox_1.default(legend.get('x'), legend.get('y') + innerPadding[0], bbox.width, bbox.height);
    }
    else if (positions[0] === 'bottom') {
        paddingBbox = new bbox_1.default(legend.get('x'), legend.get('y') - innerPadding[2], bbox.width, bbox.height);
    }
    return {
