...
var statisticTemplate = tslib_1.__importStar(require("./statistic-template"));
...
var RingStatistic = /** @class */ (function (_super) {
    ...
    RingStatistic.prototype.getStatisticTemplate = function (data) {
        ...
        else if (util_1.isObject(data) && util_1.keys(data).length === 2) {
            /** 如果文本内容为两条数据 */
            var content = data;
    ...
    RingStatistic.prototype.getStatisticHtmlString = function (data) {
        ...
        var htmlString;
        if (util_1.isString(triggerOnConfig)) {
            htmlString = this.getStatisticTemplate(data);
        }
        if (util_1.isFunction(triggerOnConfig)) {
