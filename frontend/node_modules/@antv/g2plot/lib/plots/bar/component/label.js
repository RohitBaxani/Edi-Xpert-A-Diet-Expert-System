...
var BarLabel = /** @class */ (function (_super) {
    ...
    BarLabel.prototype.getLabelItemAttrs = function (element, idx) {
        ...
        return util_1.deepMix({}, style, tslib_1.__assign(tslib_1.__assign({}, this.getPosition(element)), { text: formatter ? formatter(value, shape, idx) : value, fill: this.getTextFill(element), stroke: this.getTextStroke(element), textAlign: this.getTextAlign(element), textBaseline: this.getTextBaseline() }));
    };
