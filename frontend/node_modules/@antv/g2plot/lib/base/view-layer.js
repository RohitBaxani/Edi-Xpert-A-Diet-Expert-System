...
dependents_1.registerComponentController('gesture', dependents_1.Gestrue);
var ViewLayer = /** @class */ (function (_super) {
    ...
    ViewLayer.prototype.customTooltip = function () {
        var customContentCfg = this.options.tooltip.customContent;
        var container;
    ...
    ViewLayer.prototype.legend = function () {
        ...
        var flipOption = util_1.get(this.options, 'legend.flipPage');
        var clickable = util_1.get(this.options, 'legend.clickable');
        this.setConfig('legends', {
            position: this.getLegendPosition(util_1.get(this.options, 'legend.position')),
            formatter: util_1.get(this.options, 'legend.formatter'),
            offsetX: util_1.get(this.options, 'legend.offsetX'),
            offsetY: util_1.get(this.options, 'legend.offsetY'),
            clickable: util_1.isUndefined(clickable) ? true : clickable,
            // wordSpacing: get(this.options, 'legend.wordSpacing'),
            flipPage: flipOption,
            marker: util_1.get(this.options, 'legend.marker'),
            title: util_1.get(this.options, 'legend.title'),
        });
    };
