                ...
                <>
                    ...
                    <Container fluid className="mt-3">
                        ...
                        <Row className="justify-content-center">
                            <Button variant={this.state.foodLogButtonColor}  onClick={this.onClickShowFoodLog}  className='mr-3 white-color primary-color no-border'>
                                Daily Food Log
                            </Button>

                            <Button variant={this.state.statsButtonColor} onClick={this.onClickShowStats}  className='secondary-btn'>
                                User Statistics
                            </Button>
                        </Row>
